...
/** @type {string} */
const CACHE_VERSION = '1786183730|2288319';
/** @type {string} */
const CACHE_PREFIX = 'Droppin\' Heat-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["adsense_h5.js","index.html","index.js","index.offline.html","index.icon.png","index.apple-touch-icon.png","index.audio.worklet.js","index.audio.position.worklet.js"];
